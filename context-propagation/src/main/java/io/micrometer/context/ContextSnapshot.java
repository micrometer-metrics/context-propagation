...
public interface ContextSnapshot {
     ...
     * All currently present {@link ThreadLocal} values, for which the {@code
     * sourceContext} has no key defined, will be {@link ThreadLocalAccessor::reset} and
     ...
     * them to set {@link ThreadLocal} values. Essentially, a shortcut that bypasses the need
